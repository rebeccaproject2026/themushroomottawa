    ...
    <>
      ...
      <main className="bg-[#f5f5f5]">
        ...
        <section className="bg-[#f5f5f5] py-12 flex flex-col items-center text-center px-4">
          ...
          <h1 className="text-[35px] font-semibold text-black nav-poppins mb-2">
            Contact The Mushroom Ottawa
          </h1>
          <p className="text-lg text-[#4B4B4B] nav-poppins max-w-3xl leading-relaxed">
        ...
        <section className=" bg-white py-12">
          ...
          <div className="bg-[#f3f3f3] rounded-4xl border-2 border-[#d6d6d6] p-6 shadow-sm">
            <h2 className="text-[35px] font-semibold text-[#242424] nav-poppins mb-4">Send Us a Message</h2>
          ...
          {/* Right — Store Info */}
          <div className="flex flex-col gap-4 pl-9 pt-6.5">
            <div className="flex flex-col gap-3">
              <h2 className="text-[35px] font-semibold text-[#242424] nav-poppins">Store Info</h2>
              <p className="text-lg text-[#353535] nav-poppins font-medium">
            ...
            <div className="bg-white rounded-xl p-6 flex items-start gap-4 shadow-sm">
              <div className="w-12.5 h-12.5 rounded-full bg-[#E7F6F7] flex items-center justify-center shrink-0">
                <Icon icon="mdi:phone" className="w-8.5 h-8.5 text-[#0FA3B1]" />
              </div>
              <div>
                <p className="text-[23px] font-semibold text-[#242424] nav-poppins mb-1">Contact Details</p>
                <p className="text-lg text-[#7A7A7A] font-semibold nav-lato">(343) 999-4830</p>
                <p className="text-lg text-[#7A7A7A] font-semibold nav-lato">info@themushroomottawa.ca</p>
              </div>
            </div>

            {/* Visit Us card */}
            <div className="bg-white border border-gray-100 rounded-xl p-6 flex items-start gap-4 shadow-sm">
              <div className="w-12.5 h-12.5 rounded-full bg-[#FEEEF2] flex items-center justify-center shrink-0">
                <Icon icon="mdi:map-marker" className="w-8 h-8 text-red-400" />
              </div>
              <div className="flex flex-col gap-1">
                <p className="text-[23px] font-semibold text-[#242424] nav-poppins">Visit Us</p>
                <p className="text-lg text-[#7A7A7A] font-semibold nav-lato">779 Somerset St W, Ottawa, ON K1R 6R3</p>
              </div>
            </div>

            {/* Store Hours card */}
            <div className="bg-white border border-gray-100 rounded-xl p-6 flex items-start gap-4 shadow-sm">
              <div className="w-12.5 h-12.5 rounded-full bg-[#FFF4CE] flex items-center justify-center shrink-0">
                <Icon icon="mdi:clock" className="w-8 h-8 text-yellow-500" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-[23px] font-semibold text-[#242424] nav-poppins">Store Hours</p>
                <p className="text-lg text-[#7A7A7A] font-semibold nav-lato">Everyday: 09:00 AM - 11:00 PM</p>
              </div>
            </div>
          </div>
          </div>
