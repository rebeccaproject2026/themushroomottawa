...
export const mushroomProducts = [
  ...
  { id: 10, name: "Albino Choda",           category: "Magic Mushrooms", price: 50, maxPrice: 170, image: mm2, hoverImage: mmh1, outOfStock: true, description: "Albino Choda in Ottawa: A rare albino hybrid delivering powerful visuals, deep euphoria, and a strong body high — for experienced users." },
  { id: 11, name: "Albino Hillbilly",       category: "Magic Mushrooms", price: 50, maxPrice: 170, image: mm3, hoverImage: mmh1, outOfStock: true, description: "Albino Hillbilly in Ottawa: A unique albino variant of the Hillbilly strain — smooth, uplifting effects with gentle visuals and warm euphoria." },
  ...
  { id: 2, name: "Blue Meanie Capsules",             category: "Microdosing", price: 40, maxPrice: 80, image: prod2, outOfStock: true, description: "Blue Meanie in Ottawa: Microdosing capsules promoting relaxation, stress relief, reduced anxiety, subtle mood uplift, and calm focus." },
  { id: 3, name: "Blue Smurf Capsules",              category: "Microdosing", price: 40, maxPrice: 80, image: prod3, outOfStock: true, description: "Blue Smurf in Ottawa: Microdosing capsules promoting relaxation, stress relief, reduced anxiety, subtle mood uplift, and calm focus." },
  ...
  { id: 18, name: "Chocolate Bar Penis Envy",       category: "Psilocybin Edibles", price: 60,   maxPrice: null, image: pe2, outOfStock: true, description: "Chocolate Bar Penis Envy in Ottawa: A potent psilocybin chocolate bar with Penis Envy strain — intense visuals and deep euphoria in every bite." },
  { id: 19, name: "Chocolate Blue Meanie",          category: "Psilocybin Edibles", price: 60,   maxPrice: null, image: pe3, outOfStock: true, description: "Chocolate Blue Meanie in Ottawa: A powerful psilocybin chocolate bar with Blue Meanie strain — vivid visuals and a strong euphoric experience." },
  { id: 20, name: "Infused Tea (Chai)",             category: "Psilocybin Edibles", price: 20,   maxPrice: null, image: pe4, hoverImage: mmh1, description: "Infused Tea Chai in Ottawa: A warm and soothing psilocybin-infused chai tea — perfect for a calm and measured experience." },
  { id: 21, name: "Infused Tea (Dreamland)",        category: "Psilocybin Edibles", price: 20,   maxPrice: null, image: pe5, hoverImage: mmh1, description: "Infused Tea Dreamland in Ottawa: A relaxing psilocybin-infused herbal tea blend — designed to ease you into a dreamy, peaceful state." },
  { id: 22, name: "Infused Tea (Green)",            category: "Psilocybin Edibles", price: 20,   maxPrice: null, image: pe6, hoverImage: mmh1, description: "Infused Tea Green in Ottawa: A refreshing psilocybin-infused green tea — light, clean, and perfect for a gentle microdose experience." },
  { id: 23, name: "Microzoomiez Gummies (Cherry)",  category: "Psilocybin Edibles", price: 25,   maxPrice: 40,   image: pe7, hoverImage: mmh1, description: "Microzoomiez Gummies Cherry in Ottawa: Fun and fruity psilocybin cherry gummies — precise dosing in a delicious, easy-to-enjoy format." },
  { id: 24, name: "Microzoomiez Gummies (Grape)",   category: "Psilocybin Edibles", price: 25,   maxPrice: 40,   image: pe8, hoverImage: mmh1, description: "Microzoomiez Gummies Grape in Ottawa: Tasty psilocybin grape gummies — consistent dosing and a great flavour for an enjoyable experience." },
];
